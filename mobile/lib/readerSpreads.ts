...
function ratioOf(page: PageSize | undefined): number | null {
  if (!page || !page.w || !page.h || page.w <= 0 || page.h <= 0) return null;
...
/**
 * Pair consecutive portrait pages, but keep cover / landscape / panoramic /
 * very tall pages as singles so spreads stay readable.
 */
