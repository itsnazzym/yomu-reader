/**
 * High-Performance, Zero-Dependency QR Code Generator (Model 2, Byte Mode, EC Level M)
 * Produces pixel-perfect boolean matrix and SVG vector paths for AirDrop & Quick Share QR Codes.
 */
...
export function generateQRMatrix(text: string): boolean[][] {
  ...
  // 7. Apply standard mask 0: (r + c) % 2 === 0
  ...
  // 8. Format bits (EC Level M + Mask 0) -> 0b101010000010010
